...
public class StringsUtil {
	...
	public static final String[] TABLE_COLUMNS_CUSTOMER = { "Identificación", "Nombres", "Tel/Cel", "eMail" };
	public static final String[] NATURAL_CUSTOMER_FIELDS = { "Tipo documento", "Número", "Nombres", "Apellidos",
			"E-mail", "Teléfono", "Celular", "Dirección", "Ciudad", "Departamento" };
	public static final String[] NATURAL_CUSTOMER_DOCUMENTS_OPTIONS = { "Cédula", "Tarjeta de " + "Identidad",
	...
	public static final String PHONE_ERROR_MESSAGE = "El número de telefono fijo debe tener 8 dígitos incluyendo el indicativo de la "
			+ "ciudad";
	public static final String CELLPHONE_ERROR_MESSAGE = "El número de celular debe tener 10 dígitos";
	...
	public static final String[] LEGAL_CUSTOMER_FIELDS = { "Tipo documento", "Número", "Nombre", "Siglas", "E-mail",
			"Teléfono", "Celular", "Dirección", "Ciudad", "Departamento", "Representante Legal", "Contacto" };
	...
	public static final String[] EXPORT_CUSTOMER_FIELDS = { "Tipo ID", "Identificación", "Nombres", "e-mail",
			"Teléfono", "Celular", "Dirección", "Ciudad", "Departamento", "Representante Legal", "Contacto" };
	public static final String VEHICLES = "Vehículos";
	public static final String[] TABLE_COLUMNS_VEHICULES = { "Placa", "Servicio", "Clase", "Marca", "Línea", "Modelo" };
	public static final String[] EXPORT_VEHICLES_FIELDS = { "Placa", "Servicio", "Clase", "Marca", "Línea", "Modelo",
			"Color", "# Serie", "# Motor", "# Chasis", "VIN", "Cilindraje", "Carrocería", "Combustible", "Matrícula",
			"Tránsito", "Capacidad", "PBV", "# Ejes", "Cédula(s) Propietario(s)", "Nombres Propietario(s)" };
	public static final String[] VEHICLE_FIELDS = { "Placa", "Servicio", "Clase", "Marca", "Línea", "Modelo", "Color",
			"# Serie", "# Motor", "# Chasis", "VIN", "Cilindraje", "Carrocería", "Combustible", "Matrícula", "Tránsito",
			"Capacidad", "PBV", "# Ejes" };
	...
	public static final String[] NATURAL_OWNER_FIELDS = { "Tipo documento", "Número", "Nombres", "Apellidos" };
	...
	public static final String[] LEGAL_OWNER_FIELDS = { "Tipo documento", "Número", "Nombre", "Siglas" };
